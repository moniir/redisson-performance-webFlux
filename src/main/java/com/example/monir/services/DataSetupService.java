...
public class DataSetupService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        String sqlQueiries = StreamUtils.copyToString(resource.getInputStream(), StandardCharsets.UTF_8);
        System.out.println(sqlQueiries);
        Mono<Void> insert = Flux.range(1, 1000)
                ...
                .then();
        this.entityTemplate.getDatabaseClient().sql(sqlQueiries)
                .then()
                .then(insert)
